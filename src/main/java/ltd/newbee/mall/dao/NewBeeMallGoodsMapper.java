...
public interface NewBeeMallGoodsMapper {
    ...
    NewBeeMallGoods selectByCategoryIdAndName(@Param("goodsId") Long goodsId, @Param("goodsCategoryId") Long goodsCategoryId);
    ...
    void insertExportData(@Param("newBeeMallGoodsList")List<NewBeeMallGoodsImport> newBeeMallGoodsList);
}
